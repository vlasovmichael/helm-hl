...
// ─────────────────────────────────────────────────
//
// Docker молча поднимает убитый процесс по restart:unless-stopped, и рестарт
// проходит незаметно. [Mem] предупреждает ДО упора, tickWatchdog ловит
// замерший тик — но ни то, ни другое не срабатывает, если процесс умер
// мгновенно и поднялся за 25 мс. Нужен сигнал по самому факту рестарта.
//
