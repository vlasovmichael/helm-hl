...
// ─────────────────────────────────────────────────
// Меряется чистый ход цены на 4 / 8 / 24 часа — без стопа и без срока.
// 🚨 Замер по стопу/цели с таймаутом 2ч упирается в собственную конструкцию:
// цель не успевает достигаться.
//
// 🚨 Рядом пишется ход BTC за ТО ЖЕ окно, и это половина смысла лога: падение
// альты на общем сливе выглядит как отработавший фейд. Решение принимается по
// excess = ход монеты в сторону сетапа минус ход BTC в ту же сторону.
//
