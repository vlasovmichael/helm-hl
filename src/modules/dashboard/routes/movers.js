  ...
  try {
    ...
    const top = selected.map((m, idx) => {
      ...
      return {
        ...
        // «Вход по уже случившемуся движению»: колонки Costly side / Move в
        // строке, где монету и выбирают. Считается из готовых окон 60м/15м — ни
        // одного лишнего запроса к бирже.
