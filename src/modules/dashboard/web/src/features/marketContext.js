...
/**
 * Сбросить память о нарисованном — звать при монтировании страницы.
 *
 * 🚨 Разметка переживает уход со страницы, а модуль — нет: с поднятым `built`
 * структура плашки не строится заново, setVal пишет в несуществующие узлы, и
 * класс mc-loading никто не снимает — вечный спиннер. То же с кэшами спарклайна
 * и цены: они говорят «уже нарисовано» про узлы, которых больше нет.
 */
export function resetMarketContext() {
  built = false;
  _lastSparkKey = "";
  _lastBtcStr = "";
  _lastBtcPx = null;
