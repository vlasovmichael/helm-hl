...
//  Родом из Hot Movers (колонка цены), с 04.09.2026 его же крутит
//  Market Context для BTC — чтобы линия везде была одной толщины и
//  одного цветового кода (вверх/вниз/плоско), а не двумя похожими.
// ─────────────────────────────────────────────────
