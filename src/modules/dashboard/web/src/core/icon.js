...
//
// 🚨 Типографским глифам (▲ ▼ ✓ ⚠) и эмодзи в UI не место: каждый шрифт рисует
// их по-своему, эмодзи вообще цветным растром мимо темы, а вес не совпадает с
// текстом. Проверяет scripts/checkGlyphs.mjs в `npm run guards`.
//
 ...
 * `textContent` напечатает пользователю сырой `<svg xmlns=…>`. Проверяй сток,
 * когда добавляешь icon в существующую строку: там мог лежать глиф, которому
 * textContent был не страшен.
 *
