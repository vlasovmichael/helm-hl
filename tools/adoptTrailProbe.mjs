...
// трейл отдаёт заметно больше пика, чем настроен. Виновата петля (позу редко
// осматривают, порог перепрыгивают между взглядами) или исполнение (решение
// принято вовремя, но ордер летит и цена уходит)?
//
