...
//
//  ЗАЧЕМ: старый Spike-Fade мерил 60с-дрейф mid-цены и физически пропускал
//  ликвидационные фитили (BCH 224→207 за минуту жил только в трейд-принтах, не в
//  mid). Здесь детект по LOW/HIGH 1m-свечи (то, что видно на графике), а вход —
