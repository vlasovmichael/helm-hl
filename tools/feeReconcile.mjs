...
// ─────────────────────────────────────────────────
// 🚨 Журнал может расходиться с биржей вдвое и выглядеть при этом
// правдоподобно — а на нём стоят payoff, средний плюс и средний минус, то есть
// все выводы про торговлю.
//
